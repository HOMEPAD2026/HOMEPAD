...
(async () => {
  ...
  document.getElementById("cn-bn-commodities").addEventListener("click", () => showCnSoon("bnCommodities"));
  document.getElementById("cn-bn-rewards").addEventListener("click", () => showCnSoon("bnRewards"));
  document.getElementById("cn-bn-docs").addEventListener("click", () => showCnSoon("bnDocs"));
