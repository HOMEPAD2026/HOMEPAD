...
(function () {
  ...
  async function scanAll(io, addr, { holders, marketFallback } = {}) {
    addr = String(addr).toLowerCase();
  ...
  window.ArcScanCore = { CORE_VERSION, ADDR, BURN, labelOf, toBig, units, compact, usd, tinyNum, pct, ageText, short, POWERS, selectorsOf, readContract, readArcPad, readArgus, readLocks, readMarket, PROBE_CODE, simulate, HELP, evaluate, verdictOf, scanAll, simulateFor };
})();
